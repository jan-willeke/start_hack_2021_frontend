...
export default function IdeaHub() {
    return <div className="container p-4">
        ...
        <p className="larger">Here you can post suggestions about anything directly or indirectly related to your company. Furthermore, you have the option to vote on suggestions proposed by your fellow peers. Democracy nurtures innovation.</p>
